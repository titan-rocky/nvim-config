...
create_command("Gpp", function()
	return vim.cmd(":!g++ % -o %:h/output.out && %:h/output.out")
end, {})
create_command("Gppi", function()
	return vim.cmd(":!g++ % -o %:h/output.out && (%:h/output.out < %:h/input.in) > %:h/output.txt")
end, {})
create_command("Gpps", function()
	return vim.cmd(":!g++ % -o %:h/output.out && %:h/output.out < %:h/input.in")
end, {})
create_command("GppTemp", function()
	return vim.cmd(":!./GppTemp.sh %")
end, {})
